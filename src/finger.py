import numpy as np
import cv2
from img_utils.img_utils import ContactArea, circle_mask, align_center, center_mask
from img_utils.img_utils import _mask, square_cut
...
if __name__ == "__main__":
    ...
    #     else:
    #         fix = (8, 10)
    tactile = Finger(dev_name=device_id, serial='/dev/video', fix=(8, 10))
