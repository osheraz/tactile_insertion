...
class ExtrinsicContact:
    ...
    def _xyzquat_to_tf_numpy(self, position_quat):
        """
    ...
    def estimate_pose(self, curr_pose, prev_pos=None):
        ...
        cos_dist = np.matmul(prev_z_dir, curr_z_dir)
        ...
        curr_rod_pose[:3, :3] = np.matmnul(delta_rot, prev_rot)

        curr_rod_pose[:3, 3] = curr_pos
        return curr_rod_pose

    def get_extrinsic_contact(self, threshold=0.003, display=True, dec=None):
        ...
        query_points = trimesh.points.PointCloud(
            trimesh.sample.sample_surface(self.object_trimesh,
                                          self.n_points, seed=42)[0]).vertices
...
if __name__ == '__main__':
    ...
    mesh_plug = "/home/roblab20/osher3_workspace/src/isaacgym/python/IsaacGymInsertion/assets/factory/mesh/factory_insertion/yellow_round_peg_2in.obj"
    mesh_socket = "/home/roblab20/osher3_workspace/src/isaacgym/python/IsaacGymInsertion/assets/factory/mesh/factory_insertion/green_round_hole_2in.obj"
    # mesh_socket = "/home/roblab20/osher3_workspace/src/isaacgym/python/IsaacGymInsertion/assets/factory/mesh/factory_insertion/socket.obj"

    num_points = 300
    rospy.init_node('extrinsic_contact')
    rate = rospy.Rate(60)
    socket_pos = [0.5003975459912791, -0.002282973537034695, 0.001]
    tracker = ExtrinsicContact(socket_pos=socket_pos, mesh_plug=mesh_plug, mesh_socket=mesh_socket, num_points=num_points)
